...
class Recon:
    ...
    # Given a user's preferences, calculate the score for another user's profile
    # Implementation of equation in "Calculating compatability scores" on page 4
    ...
    # Given a user's previously liked users, calculate their preferences
    # Implementation of equations in "Finding the User's Preferences" on page 4
    ...
    def get_user_data(self, user_id):
        if user_id in self.user_data_df.index:
            user_data = self.user_data_df.loc[user_id]
